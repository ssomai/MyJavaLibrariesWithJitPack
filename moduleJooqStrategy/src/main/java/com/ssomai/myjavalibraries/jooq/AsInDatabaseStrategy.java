...
public class AsInDatabaseStrategy extends DefaultGeneratorStrategy {
    ...
    public String getJavaIdentifier(Definition definition) {
        ...
        if (definition instanceof IndexDefinition && asList(MYSQL, MARIADB).contains(definition.getDatabase().getDialect().family()))
            return ((IndexDefinition) definition).getTable().getOutputName() + "_" + definition.getOutputName();
        else
